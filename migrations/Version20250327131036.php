 ...
 */
final class Version20250327131036 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD roles JSON NOT NULL, DROP current_subscription_id_id, CHANGE username username VARCHAR(255) NOT NULL, CHANGE profile_picture profile_picture VARCHAR(255) NOT NULL, CHANGE playlist_id current_subscription_id INT DEFAULT NULL');
